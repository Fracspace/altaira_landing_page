                ...
                <div className="ml-10 mr-10">
                    <div className='max-w-7xl text-white mx-auto'>
                        ...
                        <div className='flex flex-col items-center w-full'>
                            <div className="flex flex-col gap-x-5 mx-auto max-w-5xl gap-y-10 mt-16">
                                <div className="flex flex-col md:flex-row items-center md:ml-10 gap-x-15 gap-y-10 justify-between">
